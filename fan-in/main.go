/*
	Fan In concurrency pattern is used in this program to read multiple inputs from single function
	The program reads data from two different files and writes them as output
*/
